...
public class SwapMenuScreen extends Screen {
    ...
    public SwapMenuScreen(Screen parent) {
    ...
    protected void init() {
        ...
        sourceTitle = ButtonWidget.builder(Text.literal("Перший: " + getLabel(SwapModLogic.sourceItem)), b -> {})
        ...
        targetTitle = ButtonWidget.builder(Text.literal("Другий: " + getLabel(SwapModLogic.targetItem)), b -> {})
        ...
        this.addDrawableChild(ButtonWidget.builder(Text.literal("Зберегти"), button -> {
            // Зберігаємо конфіг
            ConfigManager.config.sourceItem = SwapModLogic.sourceItem;
            ConfigManager.config.targetItem = SwapModLogic.targetItem;
            ConfigManager.save();
    ...
    private void addSourceButton(String key, String label, int x, int y) {
        ...
        if (SwapModLogic.sourceItem.equals(key)) {
    ...
    private void addTargetButton(String key, String label, int x, int y) {
        ...
        if (SwapModLogic.targetItem.equals(key)) {
            btn.setMessage(Text.literal("✔ " + label));
            targetTitle.setMessage(Text.literal("Другий: ✔ " + label));
        }
    }
